...
const statusConfig: Record<TaskStatus, { label: string; bg: string; text: string; border: string; icon: typeof CheckCircle2 }> = {
  ...
  rm_approved: { label: 'RM Approved', bg: 'bg-sky-50', text: 'text-sky-700', border: 'border-sky-200', icon: CheckCircle2 },
  zh_approved: { label: 'ZH Approved', bg: 'bg-violet-50', text: 'text-violet-700', border: 'border-violet-200', icon: CheckCircle2 },
